...
#define BRANCH_PROBE_MAX_TICKS 22
#define BRANCH_PROBE_SETTLE_TICKS 5
#define BRANCH_PROBE_MIN_LINE_TICKS 5
#define BRANCH_PROBE_LOST_TICKS 5
...
#define CODE_VERSION "probe-target-v32-strict-branch-confirm"
